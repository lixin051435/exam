        ...
        <form action="${pageContext.request.contextPath}/apply/add" name="myform" method="post" onsubmit="return true;"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow">
                    <label>学生编号</label>
                    <div class="formRight">
                        <input type="text" name="studentId" class="mws-textinput" id="id"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>学生姓名</label>
                    <div class="formRight">
                        <input type="text" name="studentName" class="mws-textinput" id="account"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>申请理由</label>
                    <div class="formRight">
                        <input type="text" name="reason" class="mws-textinput" id="password"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
