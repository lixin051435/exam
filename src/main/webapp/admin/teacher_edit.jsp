...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/teacher/edit" name="myform" method="post" onsubmit="return true;"
              class="form">
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <select name="type">
                            <option value="0" <c:if test="${'0' eq teacher.type}">selected</c:if> >否</option>
                            <option value="1" <c:if test="${'1' eq teacher.type}">selected</c:if> >是</option>
                        </select>
                    </div>
                    <div class="clear"></div>
                </div>
