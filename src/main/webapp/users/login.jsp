								...
								<form action="index/login.action" method="post" name="myform" onsubmit="return checkLogin()">
									<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
										...
										<tr>
											...
											<a bgcolor="#FFFFFF" href="index/preReg.action" style="padding-right:280px">去注册</a>
												<input type="submit" class="bnt_blue_1" style="border: none;margin-left:-420px" value="确认登录" />
											</td>
										</tr>
									</table>
								</form>
