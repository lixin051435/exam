			...
			<form action="index/deletecart.action" method="post">
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
					...
					<c:forEach items="${cartList}" var="cart">
						<tr>
							<td bgcolor="#ffffff" align="center" style="width: 300px;"><a href="index/detail.action?id=${cart.jiancaiid }"
								target="_blank"><img style="width: 80px; height: 80px;" src="${cart.image }" border="0"
									title="${cart.jiancainame }" /> </a> <br /> <a href="index/detail.action?id=${cart.jiancaiid }" target="_blank"
								class="f6">${cart.jiancainame }</a></td>
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
					<tr>
						...
						<td bgcolor="#ffffff" align="right"><a href="index/preCheckout.action"><img
								src="themes/xecmoban_haier2015/images/checkout.gif" alt="checkout" /> </a></td></c:if>
					</tr>
				</table>
			</form>
		</div>
